...
const JIRA_SCOPE = 'read:jira-work read:jira-user read:project:jira read:board-scope:jira-software read:sprint:jira-software read:issue:jira offline_access';
